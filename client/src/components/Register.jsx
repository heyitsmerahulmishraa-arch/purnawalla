    ...
    <div className="profileContainer flex flex-col gap-2 flex-1 p-5 pb-80">
      <div className="formcontainer registerContainer">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 mt-4">
          ...
          <div className="container flex flex-col gap-2 py-2">
            <label className="font-bold tracking-wider uppercase">Email</label>
            <input
              type="email"
          ...
          <div className="flex gap-4 mt-4">
            <button
              type="submit"
              className="py-3 px-5 bg-(--primary-color) font-bold hover:bg-(--primary-color-dark) text-white rounded"
            >
              Register
            </button>
            <Link
              to={"/login"}
              className="py-3 px-5 bg-(--primary-color) hover:bg-(--primary-color-dark) font-bold text-white rounded"
            >
              Login
            </Link>
          </div>

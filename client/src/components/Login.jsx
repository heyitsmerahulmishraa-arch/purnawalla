      ...
      <div className="formcontainer loginContainer">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 mt-4">
          <div className="container flex flex-col gap-2 py-2">
            <label className="uppercase font-bold tracking-wider">Email</label>
            <input
              type="email"
          ...
          <div className="container flex flex-col gap-2 py-2">
            <label className="uppercase font-bold tracking-wider">
              Password
            </label>
            <input
              type="password"
          ...
          <div className="flex gap-4 mt-4">
            <button
              type="submit"
              className="py-3 font-bold px-5 bg-(--primary-color) hover:bg-(--primary-color-dark) text-white rounded"
            >
              Login
            </button>
            <Link

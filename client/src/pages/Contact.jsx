        ...
        <div className="container ">
          <div className="mainContainer  justify-between my-5">
            ...
            <div className="contentInfoContiner flex flex-col justify-between gap-8  ">
              <div className="innerContainer border shadow-xl mt-5 p-2.5 formcontainer  max-w-[800px]  w-full">
                <form >
                  <div className="inputsFiels flex flex-col px-2.5 mb-4">
                    ...
                    <input
                      className="px-2.5 py-1.5 outline-none text-[18px] font-normal border rounded"
                      id="userinput"
                      name="username"
                      type="text"
                  ...
                  <div className="inputsFiels  flex flex-col px-2.5 mb-4">
                    ...
                    <textarea
                      className="px-2.5 py-2.5 outline-none text-[18px] font-normal border rounded"
                      id="msginput"
                      name="meassage"
                      type="text"
                      placeholder="Enter your Name"
              ...
              <div className="formcontainer googlemapontainer max-w-[800px] w-full max-h-[800px] h-[200px] border my-3">
                <iframe
